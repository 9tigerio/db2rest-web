...
GRANT create table TO LARRY;
GRANT create view TO LARRY;
GRANT create any trigger TO LARRY;
GRANT create any procedure TO LARRY;
GRANT create sequence TO LARRY;
GRANT create synonym TO LARRY;
