---
sidebar_position: 2
title: Connect DB2Rest to CockroachDB
...
For help, visit us on [Discord](https://discord.gg/fEFnNmUq) or our [GitHub Discussions](https://github.com/kdhrubo/db2rest/discussions)
