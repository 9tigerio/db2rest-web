...
In this deployment, the app service and database are not in the same [Virtual Private Cloud or VPC](https://docs.digitalocean.com/products/networking/vpc/). Hence, it is imperative
to restrict access to the database from external sources. The database dashboard already shows warning.
