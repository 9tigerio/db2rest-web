...
<Tabs>
    ...
    <TabItem value="httpie" label="HTTPie">
        ...
        http POST http://localhost:8080/actor \
...
attribute `rows` indicate the number of rows created in the table. Along with the number of rows the response payload
also contains `keys` attribute which contains the values of the generated primary key columns.
