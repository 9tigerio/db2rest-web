...
In the previous tutorial [integrate with Temp](https://db2rest.com/docs/tembo/integrate-with-tembo-pg/), the `employee` table was created on
...
running as an application service on Tembo.
