...
# How to handle large result-sets with Pagination?
...
<Tabs>
    <TabItem value="cURL" label="cURL" default>
        ```bash
        curl --request GET \
        --url 'http://localhost:8080/film?limit=5&fields=title,release_year:year' \
    ...
    <TabItem value="httpie" label="HTTPie">
        ```bash
        http GET 'http://localhost:8080/film?limit=5&fields=title,release_year:year' \
...
<Tabs>
    <TabItem value="cURL" label="cURL" default>
        ```bash
        curl --request GET \
        --url 'http://localhost:8080/film?offset=20&limit=10' \
        --header 'User-Agent: insomnia/8.6.1'
    ...
    <TabItem value="httpie" label="HTTPie">
        ```bash
        http GET 'http://localhost:8080/film?offset=20&limit=10' \
        User-Agent:insomnia/8.6.1
        ```
    </TabItem>
